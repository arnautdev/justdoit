...
var polarAreaData = {
    ...
    datasets: [{
        ...
        backgroundColor: [COLOR_GREY_TRANSPARENT_7],
...
var handleChartJs = function () {
    ...
    var $url = $(document.getElementById('polar-area-chart')).data('loaddata');
    $.get($url, function ($resp) {
        polarAreaData.labels = $resp.labels;
        polarAreaData.datasets[0].data = $resp.datasets.data;
